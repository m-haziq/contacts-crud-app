...
class ContactTests(TestCase):
    ...
    def test_get_target_contact(self):
        for _ in range(10):
            ...
            contact.save()
        response = self.client.get(f'/contacts?id={5}')
    ...
    def test_update_contact(self):
        contact = Contact(
            ...
            contact_gst_number=f'1234656'
        )
        contact.save()
        response = self.client.put('/contacts', data={"id": contact.id, "person_name": "test-done"},
    ...
    def test_del_contact(self):
        for _ in range(5):
            ...
            contact.save()
        response = self.client.delete('/contacts', data={"id": contact.id},
                                      content_type='application/json')
